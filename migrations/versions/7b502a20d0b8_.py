...
Revision ID: 7b502a20d0b8
Revises: 8ffed138dd0d
Create Date: 2019-05-29 18:34:51.628598
...
revision = '7b502a20d0b8'
down_revision = '8ffed138dd0d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('server', sa.Column('expire', sa.DATE(), nullable=True))
    op.add_column('server', sa.Column('manufacture_date', sa.DATE(), nullable=True))
    op.add_column('server', sa.Column('server_up_time', sa.DATE(), nullable=True))
