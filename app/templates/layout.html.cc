...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	...
	<li  class="dropdown" id="profile-messages" >
	    <a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="fa fa-user fa-fw"></i><span class="text">{% if errmsg %}<span style="color: red;">{{errmsg}}</span>{%else%}{{current_user.name}}{%endif%}</span> <b class="caret"></b></a>
